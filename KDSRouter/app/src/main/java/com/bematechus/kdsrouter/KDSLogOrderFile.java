 ...
 * Rev:
 */
public class KDSLogOrderFile {

    static final String TAG = "KDSOrdersLOG";

    public KDSLogOrderFile()
    {
        super();
    }
...
//            return 0;
    ...
    public static String getLogDir()
    {
        ...
        String strSaveLogPath = KDSUtil.getBaseDirCanUninstall() + "/" + DEFAULT_LOG_FOLDER +"/"+getAppName()+"/Orders";
        return strSaveLogPath;
    }
    public static String getLogFileName(Date dt)
    {
        ...
        strDateTimeFileName = "Orders_" +strDateTimeFileName;
    ...
    static public void setEnabled(boolean bEnabled)
    {
        if (bEnabled)
            m_logLevel = LogLevel.Detail;
        else
