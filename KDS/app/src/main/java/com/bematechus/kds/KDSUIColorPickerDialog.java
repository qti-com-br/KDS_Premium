...
//
//        //final View view = LayoutInflater.from(context).inflate(R.layout.xkdsui_dlg_color_picker, null);
//        final View view = LayoutInflater.from(context).inflate(R.layout.xkdsui_dialog_color_picker, null);
//
