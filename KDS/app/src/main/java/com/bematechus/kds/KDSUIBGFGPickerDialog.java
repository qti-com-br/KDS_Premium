    ...
    public KDSUIBGFGPickerDialog(final Context context, KDSBGFG bgfg, OnBGFGPickerDlgListener listener) {
        ...
        m_btnBG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                KDSUIColorPickerDialog d = new KDSUIColorPickerDialog(dialog.getContext(), Color.WHITE, new KDSUIColorPickerDialog.OnColorPickerDlgListener() {
                    @Override
        ...
        m_btnFG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                KDSUIColorPickerDialog d = new KDSUIColorPickerDialog(dialog.getContext(), Color.BLACK, new KDSUIColorPickerDialog.OnColorPickerDlgListener() {
                    @Override
                    public void onCancel(KDSUIColorPickerDialog dialog) {
