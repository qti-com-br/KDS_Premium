...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    public void setDrawSplitLine(boolean bDraw)
    {
        m_bDrawSplitLine = bDraw;
    }
...
//        canvas.draw(canvas.getClipBounds(), pt);
            Rect rt = new Rect();
//        rt.bottom = canvas.getWidth()-1;
//        rt.right = canvas.getHeight()-1;
            this.getDrawingRect(rt);

            //CanvasDC.drawBox(canvas,rt , Color.BLACK, 8);
            //canvas.drawLine(rt.right, rt.top, rt.right, rt.bottom, pt);
            canvas.drawLine(0, 0, 0, rt.bottom, pt);
        }
        super.onDraw(canvas);
    }
    ...
    private void addAndMeasureChild(final View child, int viewPos) {
        ...
        if(params == null) {
            params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);//.FILL_PARENT, LayoutParams.FILL_PARENT);
        }
