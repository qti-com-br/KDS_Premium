 ...
 */
public class STDlgInputSMBFolder {
    ...
    public STDlgInputSMBFolder(final Context context, KDSSMBPath ff, OnKDSUIDlgInputSMBFolderListener listener) {
        this.listener = listener;
        if (ff != null)
            m_smbPath.copyFrom( ff);

        final View view = LayoutInflater.from(context).inflate(R.layout.st_input_remote_folder, null);
        ...
        dialog = new AlertDialog.Builder(context)
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        saveToSmb();
                        if (STDlgInputSMBFolder.this.listener != null) {
                            STDlgInputSMBFolder.this.listener.onSMBOk(STDlgInputSMBFolder.this, getSMBPath());
                        }
                    }
                })
...
//
//                                        m_smbPath = smb;
//                                        int nError = KDSSmbFile.smb_checkFolderWritable(m_smbPath.toString());
//                                        if (nError != 0)
//                                        {
...
//        });
                ...
                new KDSSmbFile1(dialog.getContext(),
                        new KDSSmbFile1.ChosenDirectoryListener()
                        {
                            ...
                            public void onChosenDir(String chosenDir)
                            {
                                ...
                                m_txtPath.setText(smb.getFolder());
                                m_smbPath = smb;
                                int nError = KDSSmbFile1.checkFolderWritable(m_smbPath.toString());//
                                if (nError !=0)
                                {
                                    showPermissionErrorDialog(nError);
    ...
    public void showPermissionErrorDialog(int nError)
    {
