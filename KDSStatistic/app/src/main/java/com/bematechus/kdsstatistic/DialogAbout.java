...
/**
 * Similar with KDS app-->KDSUIAboutDlg.java
 */

/**
 * Created by Administrator on 2016/1/25 0025.
 */
public class DialogAbout extends KDSUIDialogBase  implements UpdateManager.UpdateEvents {

    final static String APP_NAME = "kdsstatistic";
    ...
    public DialogAbout(final Context context, String strVersion) {
        this.int_information_dialog(context, R.layout.dialog_about);
    ...
    {
        DialogAbout dlg = new DialogAbout(context, strVersion);
