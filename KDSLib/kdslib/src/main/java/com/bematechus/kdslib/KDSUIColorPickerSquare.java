...
public  class KDSUIColorPickerSquare extends View {
    Paint paint;
    Shader luar;
    final float[] color = { 1.f, 1.f, 1.f };

    public KDSUIColorPickerSquare(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public KDSUIColorPickerSquare(Context context, AttributeSet attrs, int defStyle) {
