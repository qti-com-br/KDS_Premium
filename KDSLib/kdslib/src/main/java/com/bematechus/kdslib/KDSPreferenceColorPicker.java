 ...
 */
    ...
    public class KDSPreferenceColorPicker extends Preference {
        //private final boolean supportsAlpha;
        int value;

        public KDSPreferenceColorPicker(Context context, AttributeSet attrs) {
            super(context, attrs);


            setWidgetLayoutResource(R.layout.kdsui_color_picker_pref_widget);
        }
        ...
        @Override protected void onClick() {
            if (KDSUIColorPickerDialog.g_instance != null ) return;
            new KDSUIColorPickerDialog(getContext(), value, false/*supportsAlpha*/, new KDSUIColorPickerDialog.OnColorPickerDlgListener() {
                @Override public void onOk(KDSUIColorPickerDialog dialog, int color) {
                ...
                @Override public void onCancel(KDSUIColorPickerDialog dialog) {
                    // nothing to do
                }
            }).show();
        }
